...
STAGE_PRESENTATION = {
    ...
    "review_roles": {
        ...
        "plain_next": "LINZA сначала покажет группы найденных материалов и попросит назвать формат. После этого появятся отдельные предложения на запись `role` в YAML.",
